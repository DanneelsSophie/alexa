...
const GetNewFactIntentHanlder = {
    ...
    handle(handlerInput) {
        ...
        var slots = getSlotValues(request.intent.slots);
        var city = slots.citySlot.resolved; // valeur resolue
        // what if 0 city match
        if (city === undefined
            || typeof facts[city.toLowerCase()] === 'undefined') {
            city = "france";
            speechText = "Je n'ai pas trouvé d'anecdote sur"+ slots.citySlot.synonym;
        }
        // find fact
...
exports.handler = skillBuilder
    ...
    .addRequestInterceptors(LogRequestInterceptor) // TODO STEP 04 ADD RequestPersistenceInterceptor
    .addResponseInterceptors(LogResponseInterceptor, ResponseRepeatInterceptor) // TODO STEP 04 ADD ResponsePersistenceInterceptor
    .lambda();
